...
exports.getProducts = exports.getProductById = exports.createProduct = void 0;
...
var createProduct = exports.createProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, category, price, imgURL, new_product, product_saved;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          new_product = new _products["default"]({
            name: name,
            category: category,
            price: price,
            imgURL: imgURL
